...
func UTF16ToRunes(b []byte) []rune {
	...
	_df := len(b) >> 1
	_de := make([]uint16, _df)
	for _ad := 0; _ad < _df; _ad++ {
		_de[_ad] = uint16(b[_ad<<1])<<8 + uint16(b[_ad<<1+1])
	}
	_gc := _d.Decode(_de)
	return _gc
}
...
func StringToUTF16(s string) string {
	_gf := _d.Encode([]rune(s))
	var _gb _a.Buffer
	for _, _gg := range _gf {
		_gb.WriteByte(byte((_gg >> 8) & 0xff))
		_gb.WriteByte(byte(_gg & 0xff))
	}
	return _gb.String()
}
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _bd := range b {
		_dfe, _ed := _ege[_bd]
		if !_ed {
			_g.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _bd)
			continue
		}
		_e = append(_e, _dfe)
	}
...
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _dg := range s {
		_eg, _gbd := _c[_dg]
		if !_gbd {
			_g.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _dg, _dg)
			continue
		}
		_fg.WriteByte(_eg)
	}
