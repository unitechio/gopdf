...
import (
	...
	_d "github.com/unitechio/gopdf/common"
)
...
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _ge := range s {
		_af, _dfd := _b[_ge]
		if !_dfd {
			_d.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _ge, _ge)
			continue
		}
		_ce.WriteByte(_af)
	}
...
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _gc := range b {
		_df, _f := _bg[_gc]
		if !_f {
			_d.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _gc)
			continue
		}
		_e = append(_e, _df)
	}
