...
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _cgc := range b {
		_ed, _cgd := _af[_cgc]
		if !_cgd {
			_e.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _cgc)
			continue
		}
		_a = append(_a, _ed)
	}
...
func UTF16ToRunes(b []byte) []rune {
	...
	if len(b)%2 != 0 {
		b = append(b, 0)
		_e.Log.Debug("E\u0052\u0052\u004f\u0052\u003a\u0020\u0055\u0054\u0046\u0031\u0036\u0054\u006f\u0052\u0075\u006e\u0065\u0073.\u0020\u0050\u0061\u0064\u0064\u0069\u006e\u0067\u0020\u0077it\u0068\u0020\u007ae\u0072o\u0073\u002e")
	}
	_g := len(b) >> 1
	_cg := make([]uint16, _g)
	for _bf := 0; _bf < _g; _bf++ {
		_cg[_bf] = uint16(b[_bf<<1])<<8 + uint16(b[_bf<<1+1])
	}
	_gg := _b.Decode(_cg)
	return _gg
}
func StringToUTF16(s string) string {
	_fe := _b.Encode([]rune(s))
	var _ga _fb.Buffer
	for _, _eb := range _fe {
		_ga.WriteByte(byte((_eb >> 8) & 0xff))
		_ga.WriteByte(byte(_eb & 0xff))
	}
	return _ga.String()
}

var _ff map[rune]byte
...
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _ac := range s {
		_ebd, _ec := _ff[_ac]
		if !_ec {
			_e.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _ac, _ac)
			continue
		}
		_ee.WriteByte(_ebd)
	}
