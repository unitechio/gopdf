...
func StringToPDFDocEncoding(s string) []byte {
	...
	for _, _fedd := range s {
		_da, _gg := _fe[_fedd]
		if !_gg {
			_f.Log.Debug("\u0045\u0052\u0052\u004f\u0052\u003a\u0020\u0050\u0044\u0046\u0044\u006f\u0063\u0045\u006e\u0063\u006f\u0064\u0069\u006eg\u0020\u0072\u0075\u006e\u0065\u0020\u006d\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u006d\u0069\u0073\u0073\u0069\u006e\u0067\u0020\u0025\u0063\u002f\u0025\u0058\u0020\u002d\u0020s\u006b\u0069\u0070\u0070\u0069n\u0067", _fedd, _fedd)
			continue
		}
		_eg.WriteByte(_da)
	}
...
func PDFDocEncodingToRunes(b []byte) []rune {
	...
	for _, _e := range b {
		_bcd, _baa := _cc[_e]
		if !_baa {
			_f.Log.Debug("\u0045\u0072\u0072\u006f\u0072\u003a\u0020P\u0044\u0046\u0044o\u0063\u0045\u006ec\u006f\u0064i\u006e\u0067\u0020\u0069\u006e\u0070u\u0074 m\u0061\u0070\u0070\u0069\u006e\u0067\u0020\u0065\u0072\u0072\u006f\u0072\u0020\u0025\u0064\u0020\u002d\u0020\u0073\u006b\u0069\u0070\u0070\u0069\u006e\u0067", _e)
			continue
		}
		_bb = append(_bb, _bcd)
	}
...
func UTF16ToRunes(b []byte) []rune {
	...
	if len(b)%2 != 0 {
		b = append(b, 0)
		_f.Log.Debug("E\u0052\u0052\u004f\u0052\u003a\u0020\u0055\u0054\u0046\u0031\u0036\u0054\u006f\u0052\u0075\u006e\u0065\u0073.\u0020\u0050\u0061\u0064\u0064\u0069\u006e\u0067\u0020\u0077it\u0068\u0020\u007ae\u0072o\u0073\u002e")
	}
	_fee := len(b) >> 1
	_ce := make([]uint16, _fee)
	for _fg := 0; _fg < _fee; _fg++ {
		_ce[_fg] = uint16(b[_fg<<1])<<8 + uint16(b[_fg<<1+1])
	}
	_ab := _b.Decode(_ce)
	return _ab
}
